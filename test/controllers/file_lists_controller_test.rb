...
class FileListsControllerTest < ActionController::TestCase
  ...
  test "should create file_list" do
    assert_difference('FileList.count') do
      post :create, file_list: { content: @file_list.content, gist_id: @file_list.gist_id, name: @file_list.name }
    end
  ...
  test "should update file_list" do
    patch :update, id: @file_list, file_list: { content: @file_list.content, gist_id: @file_list.gist_id, name: @file_list.name }
    assert_redirected_to file_list_path(assigns(:file_list))
  end
